...
<head>
    ...
    <title>Reset Password - KandangPRO</title>
...
<body class="bg-login min-h-screen relative flex items-center justify-center p-4">
    ...
    <div class="relative max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-extrabold text-white tracking-tight drop-shadow-md">Reset Password</h1>
            <p class="text-emerald-100/80 mt-2 font-medium drop-shadow-sm">Buat password baru untuk akun Anda</p>
        </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    <label for="password_confirmation"
                        class="block text-sm font-bold text-slate-700 mb-2 ml-1">Konfirmasi Password</label>
                    <div class="relative group">
                        <div
                            class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
